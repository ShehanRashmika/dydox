<%-- 
    Document   : aboutUs
    Created on : Jun 23, 2018, 10:42:46 PM
    Author     : Sheha
--%>
...
<html>
    ...
    <body onload="loadCartCount(), loadNoti()">
                    ...
                    <form class="form-inline my-2 my-lg-0 ">
                        ...
                        <div class="dropright">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                ...
                                <button class="dropdown-item" type="button"><a href="logOut" style="text-decoration: none;">Log Out</a></button>
        ...
        <section class="jumbotron text-center">
            <div class="container" >
                <h1 class="jumbotron-heading text-left" style="font-size: 30px;">ABOUT US</h1>
                <p class="lead text-left mb-0">
                    We're a team of developers who are passionate about creating innovative solutions for our clients' problems.We work with entrepreneurs and established brands to take ideas from concept to market.
                    We also collaborate open source projects worldwide. 
                    We work with entrepreneurs and established brands to take ideas from concept to market. We also collaborate open source projects worldwide. Our success is not only due to the quality of our work; it's down to attitude, our approach and the way we treat our clients. 
                </p>
                <br>
                <h1 class="jumbotron-heading text-left text-left" style="font-size: 30px;">OUR VISION</h1>
                <p class="lead text-left mb-0">
                    "Innovative Solutions Through Simplicity"
                </p>
                <br>
                <h1 class="jumbotron-heading text-left" style="font-size: 30px;">OUR MISSION</h1>
                <p class="lead text-left mb-0">
                    Our mission is to build up our company as the best and leading software company in sri lanka within next decade.     
                </p>
            </div>
        </section>
