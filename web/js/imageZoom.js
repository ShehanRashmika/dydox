    ...
    GlassCase.prototype = {
        init: function (options) {
            ...
            var ctntDisplayArea = "<div class='gc-display-area'>" +
                                        ...
                                        "<div class='gc-icon gc-icon-next' style='color:black;'><i class='fa fa-arrow-circle-right' style='color:black;'></i></div>" +
                                        "<div class='gc-icon gc-icon-prev' style='color:black;'><i class='fa fa-arrow-circle-left' style='color:black;'></i></div>" +
            ...
            var ctntOverlayArea = "<div class='gc-overlay-area'>" +
                                    "<div class='gc-overlay-top-icons'>" +
                                     "<div class='gc-icon gc-icon-close' style='color:black;'><i class='fa fa-close' style='color:black;'></i> </div>" +
                                        "<div class='gc-icon gc-icon-enlarge' style='color:black;'><i class='fa fa-search-plus' style='color:black;'></i>  </div>" +
                                        "<div class='gc-icon gc-icon-compress' style='color:black;'><i class='fa fa-search-minus' style='color:black;'></i>  </div>" +
                                    "</div>" +
