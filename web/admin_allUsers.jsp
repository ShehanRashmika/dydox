<%-- 
    Document   : admin_allUsers
    Created on : Jun 16, 2018, 2:27:49 PM
    Author     : Sheha
--%>
    ...
    <body onload="loadUserDataTable();">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="card-body card-block">
                                        <form class="form-horizontal" onsubmit="return false">
                                            <div class="row form-group">
                                                <div class="col col-md-2"><input id="searchById" type="text" placeholder="Search By ID.." class="form-control" onkeyup="loadUserDataTable()"></div>
                                                ...
                                                <div class="col col-md-4">
                                                    ...
                                                    <div class="custom-control custom-control-inline custom-radio my-1 mr-sm-2">
                                                        ...
                                                        <label class="custom-control-label" for="C_users">Confirmed</label>
                                                    </div>
                                                    <div class="custom-control custom-control-inline custom-radio my-1 mr-sm-2">
                                    ...
                                    <div class="col col-md-4">
                                        ...
                                        <button class=" btn btn-sm btn-success" onclick="setUserStatus('all', 'confirmed')">active all</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            ...
            function loadUserDataTable() {
                ...
                req.onreadystatechange = function() {
                    ...
                    if (req.readyState == 4 && req.status == 200) {
                        ...
                        for (x in o) {
                            ...
                            td04.innerHTML = o[x].street;

                            var td5 = document.createElement("td");
                            td5.innerHTML = o[x].zip;

                            var td6 = document.createElement("td");
                            td6.innerHTML = o[x].city;

                            var td7 = document.createElement("td");
                            td7.innerHTML = o[x].country;

                            var td8 = document.createElement("td");
                            td8.innerHTML = o[x].mobile;

                            var td9 = document.createElement("td");
                            td9.innerHTML = o[x].email;


                            var td10 = document.createElement("td");

                            if (o[x].status == "confirmed") {
                                ...
                                btn1.setAttribute("onclick", "setUserStatus('" + o[x].id + "', 'inactive')");
                                ...
                                btn2.setAttribute("onclick", "setUserStatus('" + o[x].id + "', 'confirmed')");
                                ...
                                btn3.setAttribute("onclick", "setUserStatus('" + o[x].id + "', 'confirmed')");
                ...
                req.open("get", "loadUserDataTable?json_str=" + json_str, true);
                req.send();
            }
            function setUserStatus(uid, status) {


                var json = {"mainST": "user", "uid": uid, "status": status};
                var json_str = JSON.stringify(json);
