<%-- 
    Document   : admin_sellerPackages
    Created on : Jun 18, 2018, 4:33:54 PM
    Author     : Sheha
--%>
    ...
    <body onload="loadUserDataTable();">
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">Seller Packages</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">Seller Package Table</strong>
                                </div>
                                <div class="card-body">
        ...
        <script type="text/javascript">
            ...
            function loadUserDataTable() {
                ...
                document.getElementById("sellerHasPackgeTable").innerHTML = "";
                ...
                req.onreadystatechange = function() {
                    ...
                    if (req.readyState == 4 && req.status == 200) {
                        ...
                        for (x in o) {
                            ...
                            td3.innerHTML = o[x].package;

                            var td4 = document.createElement("td");
                            td4.innerHTML = o[x].rem;

                            var td5 = document.createElement("td");
                            td5.innerHTML = o[x].inv_date;

                            var td6 = document.createElement("td");
                            td6.innerHTML = o[x].inv_status;
...
//                                td7.appendChild(btn1);
                                ...
                                btn2.setAttribute("onclick", "setUserStatus('" + o[x].sid + "', 'active')");
...
//                                td7.appendChild(btn2);
                                ...
                                btn3.setAttribute("onclick", "setUserStatus('" + o[x].sid + "', 'active')");
...
//                                td7.appendChild(btn3);
                            ...
                            var tb = document.getElementById("sellerHasPackgeTable");
...
//
                ...
                req.open("get", "loadSellerHasPackageTable?json_str=" + json_str, true);
                req.send();
            }
        </script>
    </body>
