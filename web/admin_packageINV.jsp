<%-- 
    Document   : admin_packageINV
    Created on : Jun 21, 2018, 5:34:46 PM
    Author     : Sheha
--%>
...
<html>
    ...
    <body onload="loadPackageInvoiceTable();">
        <%
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">Package Invoices</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">Package Invoices Table</strong>
                                </div>
                                <div class="card-body">
                                    <div class="card-body card-block">
                                        <form class="form-horizontal" onsubmit="return false">
                                            <div class="row form-group">
                                                <div class="col col-md-3"><input id="date" type="date" class="form-control" onchange="loadPackageInvoiceTable();"></div>
                                                <div class="col col-md-3"><input id="searchByUName" type="text" placeholder="Search By User Name.." class="form-control" onkeyup="loadPackageInvoiceTable()"></div>
                                                <div class="col col-md-2"><input id="searchByUID" type="text" placeholder="Search By UID.." class="form-control" onkeyup="loadPackageInvoiceTable()"></div>
                                                <div class="col col-md-4">

                                                    <div class="custom-control custom-control-inline custom-radio my-1 mr-sm-2">
                                                        <input type="radio" class="custom-control-input" id="all" name="1" checked onchange="loadPackageInvoiceTable()">
                                                        <label class="custom-control-label" for="all">All</label>
                                                    </div>
                                                    <div class="custom-control custom-control-inline custom-radio my-1 mr-sm-2">
                                                        <input type="radio" class="custom-control-input" id="C_users" name="1"  onchange="loadPackageInvoiceTable()">
                                                        <label class="custom-control-label" for="C_users">Done</label>
                                                    </div>
                                                    <div class="custom-control custom-control-inline custom-radio my-1 mr-sm-2">
                                                        <input type="radio" class="custom-control-input" id="I_users" name="1" onchange="loadPackageInvoiceTable()">
        ...
        <script type="text/javascript">
            function printInvoiceTable() {
                ...
                var json_obj = {"inv_id": arr_1, "date": arr_2, "uid": arr_3, "user": arr_4, "status": arr_5};
                ...
                req.open("get", "jasper_packageInvoice?json_str=" + json_str, true);
                req.send();
            ...
            function loadPackageInvoiceTable() {

                document.getElementById("packageInvoiceTable").innerHTML = "";
                ...
                req.onreadystatechange = function() {
                    ...
                    if (req.readyState == 4 && req.status == 200) {
                        ...
                        for (x in o) {
                            ...
                            td4.innerHTML = o[x].uid;

                            var td5 = document.createElement("td");
                            td5.innerHTML = o[x].u_name;
                            ...
                            var tb = document.getElementById("packageInvoiceTable");
...
//
                ...
                req.open("get", "loadPackageInvoiceTable?json_str=" + json_str, true);
                req.send();
